...
test(
    'test email',
    function () {
        expect(testFunction('testt@esdt.com')).toBe(true)
...
test(
    'main.js calculateSum() 테스트',
    function () {
        expect(main.calculateSum(5)).toBe(15)
...
test(
    ...
    function () {
        ...
        expect(main.countAir(cityAir)).toBe(9)
